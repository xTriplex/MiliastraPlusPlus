...
namespace
{
    void TestValidDataAndControlEdges(const NodeDescriptorRegistry& Descriptors)
    {
        GraphIR ValidGraph;
    ...
    void TestInvalidControlEndpointTypes(const NodeDescriptorRegistry& Descriptors)
    {
    ...
    void TestGraphIRDiagnosticsAndTypedBindings(const NodeDescriptorRegistry& Descriptors)
    {
...
int main()
{
    ...
    TestValidDataAndControlEdges(Descriptors);
    TestInvalidControlEndpointTypes(Descriptors);
    TestGraphIRDiagnosticsAndTypedBindings(Descriptors);
