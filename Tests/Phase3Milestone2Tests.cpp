...
namespace
{
    void TestCppTypeMappingsAndScalarBridges(const NodeDescriptorRegistry& Descriptors)
    {
    ...
    void TestEntityOutputsAndVariables(const NodeDescriptorRegistry& Descriptors)
    {
        {
    ...
    void TestTypedBuilderConstructionAndBindingRules(const NodeDescriptorRegistry& Descriptors)
    {
        GraphBuilder Builder(Descriptors);
    ...
    void TestBuilderHandleAndTemporaryLifetime(const NodeDescriptorRegistry& Descriptors)
    {
        {
    ...
    void TestDescriptorRegistryMutationFailures(const NodeDescriptorRegistry& Descriptors)
    {
        {
...
int main()
{
    ...
    TestCppTypeMappingsAndScalarBridges(Descriptors);
    TestEntityOutputsAndVariables(Descriptors);
    TestTypedBuilderConstructionAndBindingRules(Descriptors);
    TestBuilderHandleAndTemporaryLifetime(Descriptors);
    TestDescriptorRegistryMutationFailures(Descriptors);
