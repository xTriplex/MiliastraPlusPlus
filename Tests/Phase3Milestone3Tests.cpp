...
namespace
{
    void TestGenericOutputConstraintConflictsAndOwnerIsolation(const NodeDescriptorRegistry& Descriptors)
    {
        {
            GraphIR Graph;
            AddNode(Graph, NodeInstanceId(1U), GenericDescriptorId);
    ...
    void TestGenericBindingsAndMalformedInputs(const NodeDescriptorRegistry& Descriptors)
    {
        {
            GraphIR Graph;
            AddNode(Graph, NodeInstanceId(1U), GenericDescriptorId);
    ...
    void TestBuilderGenericBindingsAndRegistryLifetime(const NodeDescriptorRegistry& Descriptors)
    {
        {
    ...
    void TestDeterministicDiagnosticOrdering(const NodeDescriptorRegistry& Descriptors)
    {
        {
    ...
    void TestPerBindingOutputTypeConstraints(const NodeDescriptorRegistry& Descriptors)
    {
        {
            GraphIR Graph;
            AddNode(Graph, NodeInstanceId(1U), GenericDescriptorId);
    ...
    void TestMalformedReferencesAndTypeBoundaries(const NodeDescriptorRegistry& Descriptors)
    {
        {
            GraphIR Graph;
            AddNode(Graph, NodeInstanceId(1U), GenericDescriptorId);
...
int main()
{
    ...
    TestGenericOutputConstraintConflictsAndOwnerIsolation(Descriptors);
    TestGenericBindingsAndMalformedInputs(Descriptors);
    TestBuilderGenericBindingsAndRegistryLifetime(Descriptors);
    TestDeterministicDiagnosticOrdering(Descriptors);
    TestPerBindingOutputTypeConstraints(Descriptors);
    TestMalformedReferencesAndTypeBoundaries(Descriptors);
