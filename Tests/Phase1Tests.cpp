...
namespace
{
    void TestGraphNodePinAndLinkValidation()
    {
    ...
    void TestGenericTypePropagation()
    {
...
int main()
{
    TestGraphNodePinAndLinkValidation();
    TestGenericTypePropagation();
