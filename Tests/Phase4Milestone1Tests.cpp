...
namespace
{
    void TestExecutionIdentifierValidity()
    {
    ...
    void TestUnstructuredAndTrustedDescriptorSchemas(const NodeDescriptorRegistry& Registry)
    {
    ...
    void TestStructuredPersistenceAndValidation(const NodeDescriptorRegistry& Registry)
    {
...
int main()
{
    ...
    TestExecutionIdentifierValidity();
    TestUnstructuredAndTrustedDescriptorSchemas(Registry);
    TestStructuredPersistenceAndValidation(Registry);
