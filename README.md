...
Labeled transfers, phi/SSA behavior, GIA/GIL integration, metadata ingestion, backend compilation, and runtime/editor integration remain out of scope. No implicit Join, Repeat edge, or phi/SSA behavior is provided.
